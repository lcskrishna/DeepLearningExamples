...
DATASET=/datasets/datasets/wikipedia_bookcorpus_hdf5/hdf5_lower_case_1_seq_len_128_max_pred_20_masked_lm_prob_0.15_random_seed_12345_dupe_factor_5/books_wiki_en_corpus
...
CMD=" $CODEDIR/run_pretraining_profile.py"
...
if [ "$create_logfile" = "true" ] ; then
  ...
  LOGFILE=$RESULTS_DIR/"bert-large-perf-${NUM_GPUS}gpus.txt"
